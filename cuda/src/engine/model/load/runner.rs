...
use models::{
    ...
    weights::{BlockFormat, TensorCatalog},
};
use uuid::Uuid;

use super::super::{
    ModelExecution, ModelRunner,
    generation::{
...
use crate::{
    ...
    engine::{CudaEngine, batch::DecodeBuckets, lowering::CudaDecoderPlan},
};

impl CudaEngine {
    #[allow(clippy::too_many_arguments)]
    pub(super) fn load_task_runner(
        &self,
    ...
    fn load_standard_runner(
        ...
        let projection_format = super::super::projection::format(bindings);
