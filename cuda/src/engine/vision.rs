...
impl CudaEngine {
    ...
    pub fn prefill_pooled_vision_with_progress(
        ...
        let super::vision_model::LoadedVisionModel::Pooled(tower) = vision else {
    ...
    pub fn prefill_spatial_merge_vision_with_progress(
        ...
        let super::vision_model::LoadedVisionModel::SpatialMerge(tower) = vision else {
            return Err(Error::UnsupportedVisionContract(
...
) -> Result<&super::vision_model::LoadedVisionModel> {
